    ...
    <>
      ...
      <section className='hero'>
        <div className='container'>
          ...
          <Link href='services' className='btn btn--more-info'>
            Find out more &#62;
          </Link>
        </div>
            ...
            <div className='inner-container'>
              ...
              >
                <Card
                  ...
                  imgSrc='/assets/icons/quality-guarantee.svg'
                ...
                <Card
                  className='card card--why-us'
                  imgSrc='/assets/icons/pricetag.svg'
        ...
        <div className='container' ref={entitlements}>
          ...
          >
            <Card
              ...
              imgSrc='/assets/icons/booking-reminder-icon.svg'
            ...
            <Card
              className='card card--entitlements'
              imgSrc='/assets/icons/ccard-icon.svg'
              imgClassName='ccard'
        ...
        <div className='container' ref={bookNow}>
          ...
          >
            <Card
              ...
              imgSrc='/assets/icons/quote-icon.svg'
            ...
            <Card
              className='card card--booking'
              imgSrc='/assets/icons/date_time_location.svg'
            ...
            <Card
              className='card card--booking'
              imgSrc='/assets/icons/cleaning-icon.svg'
