...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Clear Drip | Privacy Policy</title>
      </Head>
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class='subtitle'>
                    Last updated <bdt className='question'>July 19, 2023</bdt>
                  </span>
                </span>
              </strong>
            </span>
              ...
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class='body_text'>
                    ...
                    <bdt className='question'>
                      <Link
                        href='https://www.cleardrip.co.uk'
                        target='_blank'
                        data-custom-class='link'
                      >
                        https://www.cleardrip.co.uk
                      </Link>
                    </bdt>
                    <span style={{ fontSize: 15 }}>
                      <span style={{ color: 'rgb(89, 89, 89)' }}>
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: 'rgb(127, 127, 127)' }}>
                  <span data-custom-class='body_text'>
                    ...
                    <bdt className='question'>info@cleardrip.co.uk</bdt>.
                  </span>
                </span>
              </span>
            </div>
            ...
            <div style={{ lineHeight: '1.5' }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class='body_text'>
                  ...
                  <bdt className='question'>
                    <Link
                      href='http://www.cleardrip.co.uk/contact'
                      target='_blank'
                      data-custom-class='link'
                    >
                      http://www.cleardrip.co.uk/contact
                    </Link>
                  </bdt>
              ...
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class='body_text'>
                    ...
                    <bdt className='question'>
                      <Link
                        href='http://www.cleardrip.co.uk/cookie-policy'
                        target='_blank'
                        data-custom-class='link'
                      >
                        http://www.cleardrip.co.uk/cookie-policy
                      </Link>
                    </bdt>
                    .<bdt className='block-component' />
                  </span>
